...
> {
    ...
    update_transaction: UpdateTransactionHandler<A, T, P>,
    delete_transaction: DeleteTransactionHandler<A, T, P>,
    transfer_funds: TransferFundsHandler<A, T, P, I, ID>,
    reconcile_transaction: ReconcileTransactionHandler<A, T, P>,
